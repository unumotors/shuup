...
window.DashboardCharts = (function (Chart) {
    ...
    var colorPalette = ["#429AAF", "#C54141", "#D16B2C", "#555555", "#7F5C99", "#409AAF", "#94B933", "#CFBE00", "#41589B"];
    ...
    function configureChartData(chartData) {
        var color = getNextColorFromPalette();
        ...
        chartData.options.tooltips = {
            callbacks: {
                label: function label(tooltipItem, data) {
                    ...
                    var formattedData = data.datasets[tooltipItem.datasetIndex].formatted_data;
                    var value = formattedData ? formattedData[tooltipItem.index] : tooltipItem.yLabel.toLocaleString();
